...
<body>
    ...
    <main>
        <section class="container ">
            <div class="row">
                <div class="card shadow pb-5 mt-5">
                    <div class="mkheader">
            ...
            <div class="row">
                <form class="form-horizontal form-section" id="a-div">
                    ...
                    <div class="form-group form-content1">
                        ...
                        <select class="form-control" id="institute_name" name="medical_college_id" required>
                            <option value="119">Khawja Eunus Ali Medical College Dental Unit</option>
                            <option value="120">North East Medical College Dental Unit</option>
                            <option value="121">North East Medical College, Sylhet</option>
                        </select>
                    ...
                    <div class="form-group form-content1">
                        ...
                        <select class="form-control" id="admission_year" placeholder="Admission Year:"
                    ...
                    <div class="form-group form-content1">
                        ...
                        <select class="form-control" id="bmdc_no" placeholder="Bmdc No" name="bmdc_No" required>
                        <option value="">None</option>
                ...
                <form class="form-horizontal form-section"id="d-div">
                    ...
                    <div class="form-group form-content1">
                        <label class="control-label col-sm-4" for="institute_name">Medical Collage:</label>
                        <select class="form-control" id="institute_name" name="medical_college_id" required>
                            <option value="502">Bangladesh Open University</option>
                            <option value="503">National University of Bangladesh</option>
                            <option value="504">Islamic Arabic University</option>
                        </select>
                        <input type="hidden" name="new_medical_college" id="new_medical_college">
                    </div>
    ...
    <script src="https://www.genesisbcscare.com/js/popper.min.js"></script>
    <script src="https://www.genesisbcscare.com/js/bootstrap.min.js"></script>
    <script src="https://www.genesisbcscare.com/js/jquery-2.1.1.min.js"></script>
    <script src="https://www.genesisbcscare.com/js/jquery.waypoints.min.js"></script>



    <script src="https://www.genesisbcscare.com/js/jquery.counterup.min.js"></script>
    <script src="https://www.genesisbcscare.com/js/msi-typing.min.js"></script>
    <script src="https://www.genesisbcscare.com/js/slick.min.js"></script>



    <script defer src="https://www.genesisbcscare.com/js/script.js"></script>
