                    ...
                    <div class="myleftctn">
                        <form class="myform text-center">
                            ...
                            <div class="form-group">
                                ...
                                <input class="myinput" type="text" class="form-control" placeholder="username"
                                    aria-label="username">
                            </div>
                            <div class="form-group">
                                <i class="fa fa-pencil"></i>
                            ...
                            <div class="form-group">
                                <lebel>
                                    ...
                                    <input id="check-1" name="check-1" type="checkbox" required><small>I read and agree
                                        to terms
                                        and condition</small></input></label>
                            </div>
                        </form>
                    </div>
                </div>
