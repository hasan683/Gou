...
<div class="position-relative">
  ...
  <div class="position-absolute bottom-50 end-50">
    ...
    <p class="text-white">It is a long established fact that a reader will be distracted by the there are many<br>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-6 product-price">
                <button type="button" class="btn btn-primary">250 taka</button></div>
            </div>
